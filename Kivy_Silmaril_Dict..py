...
class MySilmarillionApp(App):
    def build(self):
        self.box = BoxLayout(orientation='vertical')

        self.text_input = TextInput(hint_text="Enter a name", size_hint=(1, 0.2))
        self.box.add_widget(self.text_input)

        self.label = Label(text="Description will appear here", size_hint=(1, 0.6))
        self.box.add_widget(self.label)

        self.button = Button(text="Get Description", size_hint=(1, 0.2))
        self.button.bind(on_press=self.get_description)
    ...
    def get_description(self, instance):
        ...
        description = Silmarillion_names.get(name, "Name not found")
        self.label.text = description

if __name__ == "__main__":
    MySilmarillionApp().run()